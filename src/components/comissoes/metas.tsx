      ...
      <Card>
        <CardContent className="space-y-2 py-4">
            ...
            <span className="text-xs text-muted-foreground tnum">
              ...
              {formatBRL(
                lojas.reduce(
                  (acc, l) =>
                    acc +
                    (somaImportadaPorLoja.get(l.id)?.total ?? somaSemanas(porLoja[l.id])),
                  0,
                ),
              )}
            </span>
          ...
          <p className="text-[11px] text-muted-foreground">
            Com metas importadas, a meta da loja é a <strong>soma</strong> das metas dos vendedores
            dela e não se digita aqui. Os campos por semana só valem para loja que ainda não tem
            metas importadas.
          </p>
                  ...
                  <div className="mb-1.5 flex flex-wrap items-baseline justify-between gap-2">
                    ...
                    <span className="text-xs text-muted-foreground tnum">
                      ...
                      {importada
                        ...
                        : ""}
                      {daLoja.length > 0 ? ` · ${daLoja.length} pessoa(s) com meta individual` : ""}
                    </span>
                  </div>
