...
const fn = process.argv[2] === "sync" ? "cteSincronizarAgora" : "cteTestarConexao";
const url = `https://southamerica-east1-central-nfe-1c8d8.cloudfunctions.net/${fn}`;
console.log(`Chamando ${fn} (CT-e, PRODUÇÃO)...`);
