...
const url = "https://southamerica-east1-central-nfe-1c8d8.cloudfunctions.net/nfeReprocessarItens";
const r = await fetch(url, { method: "POST", headers: { "Content-Type": "application/json", Authorization: `Bearer ${ex.idToken}` }, body: JSON.stringify({ data: { companyId } }) });
...
try {
  ...
  console.log("Resposta não-JSON (primeiros 400 chars):");
